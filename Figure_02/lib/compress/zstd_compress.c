                      ...
                      void* entropyWorkspace, size_t entropyWkspSize)
{
    ...
    // printf("ZSTD_buildSequencesStatistics ----FSE\n");
    ...
    // printf("ZSTD_buildSequencesStatistics end\n");
    printf("ZSTD_buildSequencesStatistics (FSE) Elapsed time: %lld ns\n", elapsed_time);
    return stats;
}
                        ...
                        const int bmi2)
{
    // struct timespec start, end;
    // long long elapsed_time;
    // printf("ZSTD_entropyCompressSeqStore_internal start\n");
    // clock_gettime(CLOCK_MONOTONIC, &start);
    ...
    // // 计算秒数和微秒数
    // elapsed_time = (end.tv_sec - start.tv_sec) * 1000000000LL + (end.tv_nsec - start.tv_nsec);
    // printf("ZSTD_entropyCompressSeqStore_internal end\n");
    // printf("ZSTD_entropyCompressSeqStore_internal Elapsed time: %lld ns\n", elapsed_time);
...
static size_t ZSTD_buildSeqStore(ZSTD_CCtx* zc, const void* src, size_t srcSize)
{
    struct timespec start, end;
    long long elapsed_time;
    // printf("ZSTD_buildSeqStore ----LZ77\n");
    clock_gettime(CLOCK_MONOTONIC, &start);
    ...
    // 计算秒数和微秒数
    elapsed_time = (end.tv_sec - start.tv_sec) * 1000000000LL + (end.tv_nsec - start.tv_nsec);
    // printf("ZSTD_buildSeqStore end\n");
    printf("ZSTD_buildSeqStore Elapsed (LZ77) time: %lld ns\n", elapsed_time);
    return ZSTDbss_compress;
}
                                    ...
                                    ZSTD_buffered_policy_e zbuff)
{
    // struct timespec start, end;
    // long long elapsed_time;
    // printf("ZSTD_compressBegin_internal start\n");
    // clock_gettime(CLOCK_MONOTONIC, &start);
    ...
    // // 计算秒数和微秒数
    // elapsed_time = (end.tv_sec - start.tv_sec) * 1000000000LL + (end.tv_nsec - start.tv_nsec);
    // printf("ZSTD_compressBegin_internal end\n");
    // printf("ZSTD_compressBegin_internal Elapsed time: %lld ns\n", elapsed_time);
    return 0;
}
                         ...
                         const void* src, size_t srcSize)
{
    // struct timespec start, end;
    // long long elapsed_time;
    // printf("ZSTD_compressEnd_public start\n");
    // clock_gettime(CLOCK_MONOTONIC, &start);
    size_t endResult;
    ...
    // // 计算秒数和微秒数
    // elapsed_time = (end.tv_sec - start.tv_sec) * 1000000000LL + (end.tv_nsec - start.tv_nsec);
    // printf("ZSTD_compressEnd_public end\n");
    // printf("ZSTD_compressEnd_public Elapsed time: %lld ns\n", elapsed_time);
